...
mods.thaumcraft.Infusion.registerRecipe("cheaterthaum", "INFUSION", <thaumcraft:thaumonomicon:1>, 13,
	[<aspect:alienis> * 64, <aspect:praecantatio> * 96, <aspect:vitium> * 80, <aspect:alkimia> * 48, <aspect:cognitio> * 250],
	<thaumcraft:curio:6>,
	[<botania:manaresource:9>, <bloodmagic:slate:3>, <thaumcraft:primordial_pearl>, <astralsorcery:itemcraftingcomponent:4>, <thaumcraft:curio:1>, <cyberware:body_part:1>]);
...
mods.astralsorcery.Altar.addDiscoveryAltarRecipe("thaumcraft_sliver", <thaumcraft:nugget:9>, 120, 200, [
	<ore:gemChippedCertusQuartz>,null,null,null,null,null,null,null,null]);

mods.astralsorcery.Altar.addDiscoveryAltarRecipe("thaumcraft_sliver_quartzite", <thaumcraft:nugget:9>, 120, 200, [
	<ore:gemChippedQuartzite>,null,null,null,null,null,null,null,null]);

mods.astralsorcery.Altar.addDiscoveryAltarRecipe("thaumcraft_sliver_netherQuartz", <thaumcraft:nugget:9>, 120, 200, [
	<ore:gemChippedNetherQuartz>,null,null,null,null,null,null,null,null]);

	#cinnabar
mods.astralsorcery.Altar.addDiscoveryAltarRecipe("thaumcraft_cinnabar", <thaumcraft:quicksilver>, 120, 200, [
...
mods.thaumcraft.ArcaneWorkbench.registerShapedRecipe("thaumcraft:filters", "TUBES", 15, [<aspect:aqua>], <thaumcraft:filter>,
